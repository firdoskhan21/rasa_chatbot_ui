...
import PrivacyPolicyModal from "./privacy_policy.js";
import "./index.css";
...
const WelcomeMsg = ({ getNextStep }) => {
  ...
  return (
    <div className="welcome-container">
      <div className="welcome-card">
        ...
        <div className="card">
          ...
          <p>
            ...
            accordance with our <span style={{ color: "blue", cursor: "pointer", }} onClick={() => {
              setModel(true)
            }}>Privacy Policy</span>. Your data will be used for
      ...
      {model ?
        <PrivacyPolicyModal isOpen={model} setIsOpen={setModel} /> : null}
